...
(object)["list" => _::spread([1, true, (isset($componentCtx["data"]->{"ext"}) ? $componentCtx["data"]->{"ext"} : null), "erik", (isset($componentCtx["data"]->{"ext2"}) ? $componentCtx["data"]->{"ext2"} : null)], [0,0,1,0,1])], true, $componentCtx, "x-l", $sourceSlots);
$sourceSlots = null;
$html .= "</div>";
return $html;
};
