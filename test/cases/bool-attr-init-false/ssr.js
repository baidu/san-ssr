...
componentRenderers._id10 = componentRenderers._id10|| _id10;
var _id10Proto = {
filters: {
...
function _id10(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id10Proto,
...
return componentRenderers._id10(data, noDataOutput)
}