...
function _id294($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id294Proto = [
"filters" => [
...
$html .= "<button";
$html .= San::boolAttrFilter('disabled', San::escapeHTML((isset($componentCtx["data"]->{"distate"}) ? $componentCtx["data"]->{"distate"} : null)));
$html .= ">button</button></div>";
return $html;
};
return call_user_func("_id294", $data, $noDataOutput);
}; ?>