...
$html .= "result " . _::escapeHTML($componentCtx["proto"]["op"][(isset($componentCtx["data"]->{"isUp"}) ? $componentCtx["data"]->{"isUp"} : null)?"plus":"minus"]((isset($componentCtx["data"]->{"num1"}) ? $componentCtx["data"]->{"num1"} : null), (isset($componentCtx["data"]->{"num2"}) ? $componentCtx["data"]->{"num2"} : null)));
$html .= "</u>";
return $html;
};
