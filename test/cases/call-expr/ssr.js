...
html += "result " + escapeHTML(10+(componentCtx.data.base!==0?componentCtx.proto.enhance(componentCtx.data.num, componentCtx.proto.abs(componentCtx.data.base)):componentCtx.proto.enhance(componentCtx.data.num, 1)));
html += "</u>";
return html;
};
