...
$html .= "result " . _::escapeHTML(10+((isset($componentCtx["data"]->{"base"}) ? $componentCtx["data"]->{"base"} : null)!==0?$componentCtx["proto"]["enhance"]((isset($componentCtx["data"]->{"num"}) ? $componentCtx["data"]->{"num"} : null), $componentCtx["proto"]["abs"]((isset($componentCtx["data"]->{"base"}) ? $componentCtx["data"]->{"base"} : null))):$componentCtx["proto"]["enhance"]((isset($componentCtx["data"]->{"num"}) ? $componentCtx["data"]->{"num"} : null), 1)));
$html .= "</u>";
return $html;
};
