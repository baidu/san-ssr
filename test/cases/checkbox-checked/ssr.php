...
$html .= _::attrFilter('value', _::escapeHTML((isset($componentCtx["data"]->{"item"}) ? $componentCtx["data"]->{"item"} : null)));
}
if (_::contains((isset($componentCtx["data"]->{"cValue"}) ? $componentCtx["data"]->{"cValue"} : null), _::escapeHTML((isset($componentCtx["data"]->{"item"}) ? $componentCtx["data"]->{"item"} : null)))) {
$html .= " checked";
}
$html .= ">";
