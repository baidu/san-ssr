...
function _id172($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id172Proto = [
"filters" => [
...
function _id171($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id171Proto = [
...
$sourceSlots = [];
$html .= call_user_func("_id172", 
(object)["title" => (isset($componentCtx["data"]->{"title"}) ? $componentCtx["data"]->{"title"} : null),
"text" => (isset($componentCtx["data"]->{"text"}) ? $componentCtx["data"]->{"text"} : null)], true, $componentCtx, "ui-label", $sourceSlots);
$sourceSlots = null;
$html .= "</div>";
return $html;
};
return call_user_func("_id171", $data, $noDataOutput);
}; ?>