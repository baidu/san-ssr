...
componentRenderers._id41 = componentRenderers._id41|| _id41;
var _id41Proto = {
filters: {
...
function _id41(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id41Proto,
...
componentRenderers._id40 = componentRenderers._id40|| _id40;
var _id40Proto = {
filters: {
...
function _id40(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id40Proto,
sourceSlots: sourceSlots,
...
var $sourceSlots = [];
html += componentRenderers._id41(
{"title":componentCtx.data.name,
"text":componentCtx.data.jokeName}, true, componentCtx, "ui-label", $sourceSlots);
$sourceSlots = null;
...
return componentRenderers._id40(data, noDataOutput)
}