...
function _id132($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id132Proto = [
"filters" => [
...
$html .= "hello " . (isset($componentCtx["data"]->{"name"}) ? $componentCtx["data"]->{"name"} : null) . "!";
$html .= "<!--/s-text--><b>bbb</b></a>";
return $html;
};
return call_user_func("_id132", $data, $noDataOutput);
}; ?>