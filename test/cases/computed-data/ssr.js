...
componentRenderers._id66 = componentRenderers._id66|| _id66;
var _id66Proto = {
filters: {
...
realTitle: function (componentCtx) {
            return 'real' + componentCtx.data.title
        }
},
computedNames: [
"realTitle"
...
function _id66(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id66Proto,
sourceSlots: sourceSlots,
data: data || {"realTitle":"realundefined"},
owner: parentCtx,
slotRenderers: {}
};
if (data) {
componentCtx.data["realTitle"] = componentCtx.data["realTitle"] || "realundefined";
}
...
html += "<b";
if (componentCtx.data.realTitle) {
html += attrFilter("title", escapeHTML(componentCtx.data.realTitle));
}
html += ">";
html += escapeHTML(componentCtx.data.realTitle);
html += "</b></div>";
return html;
};
return componentRenderers._id66(data, noDataOutput)
}