...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"realTitle"}) ? $componentCtx["data"]->{"realTitle"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"realTitle"}) ? $componentCtx["data"]->{"realTitle"} : null));
$html .= "</b></div>";
return $html;
};
