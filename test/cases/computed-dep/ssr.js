...
componentRenderers._id68 = componentRenderers._id68|| _id68;
var _id68Proto = {
filters: {
...
less: function (componentCtx) {
            return componentCtx.data.normal - 1
        },normal: function (componentCtx) {
            return componentCtx.data.num
...
function _id68(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id68Proto,
sourceSlots: sourceSlots,
data: data || {"less":NaN,"more":NaN},
owner: parentCtx,
slotRenderers: {}
};
if (data) {
componentCtx.data["less"] = componentCtx.data["less"] || NaN;
componentCtx.data["more"] = componentCtx.data["more"] || NaN;
}
...
html += "<a>";
html += escapeHTML(componentCtx.data.less);
html += "</a><u>";
html += escapeHTML(componentCtx.data.normal);
html += "</u><b>";
html += escapeHTML(componentCtx.data.more);
html += "</b></div>";
return html;
};
return componentRenderers._id68(data, noDataOutput)
}