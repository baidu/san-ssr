...
$html .= "<a>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"less"}) ? $componentCtx["data"]->{"less"} : null));
$html .= "</a><u>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"normal"}) ? $componentCtx["data"]->{"normal"} : null));
$html .= "</u><b>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"more"}) ? $componentCtx["data"]->{"more"} : null));
$html .= "</b></div>";
return $html;
};
