...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"dataTitle"}) ? $componentCtx["data"]->{"dataTitle"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"dataText"}) ? $componentCtx["data"]->{"dataText"} : null));
$html .= "</span></a>";
return $html;
};
