...
componentRenderers._id82 = componentRenderers._id82|| _id82;
var _id82Proto = {
filters: {
year: function (date) {
...
function _id82(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id82Proto,
sourceSlots: sourceSlots,
data: data || {"date":new Date(431366400000)},
owner: parentCtx,
slotRenderers: {}
};
if (data) {
componentCtx.data["date"] = componentCtx.data["date"] || new Date(431366400000);
}
...
html += "<b";
if (componentCtx.data.date) {
html += attrFilter("title", escapeHTML(callFilter(componentCtx, "year", [componentCtx.data.date])));
}
html += ">";
html += escapeHTML(callFilter(componentCtx, "year", [componentCtx.data.date]));
html += "</b></div>";
return html;
};
return componentRenderers._id82(data, noDataOutput)
}