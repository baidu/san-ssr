...
$html .= _::attrFilter('title', _::escapeHTML(_::callFilter($componentCtx, "year", [(isset($componentCtx["data"]->{"date"}) ? $componentCtx["data"]->{"date"} : null)])));
}
$html .= ">";
$html .= _::escapeHTML(_::callFilter($componentCtx, "year", [(isset($componentCtx["data"]->{"date"}) ? $componentCtx["data"]->{"date"} : null)]));
$html .= "</b></div>";
return $html;
};
