...
$defaultSlotRender = function ($componentCtx) {
  $html = "";
$html .= "<p>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"n"}) ? $componentCtx["data"]->{"n"} : null)) . "," . _::escapeHTML((isset($componentCtx["data"]->{"sex"}) ? $componentCtx["data"]->{"sex"} : null)) . "," . _::escapeHTML((isset($componentCtx["data"]->{"email"}) ? $componentCtx["data"]->{"email"} : null)) . " - " . _::escapeHTML((isset($componentCtx["data"]->{"desc"}) ? $componentCtx["data"]->{"desc"} : null));
$html .= "</p>";
