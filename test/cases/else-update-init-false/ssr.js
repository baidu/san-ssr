...
componentRenderers._id101 = componentRenderers._id101|| _id101;
var _id101Proto = {
filters: {
...
function _id101(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id101Proto,
...
return componentRenderers._id101(data, noDataOutput)
}