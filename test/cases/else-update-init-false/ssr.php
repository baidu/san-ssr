...
function _id285($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id285Proto = [
"filters" => [
...
$html .= San::attrFilter('title', San::escapeHTML((isset($componentCtx["data"]->{"name2"}) ? $componentCtx["data"]->{"name2"} : null)));
}
$html .= ">";
$html .= San::escapeHTML((isset($componentCtx["data"]->{"name2"}) ? $componentCtx["data"]->{"name2"} : null));
$html .= "</span>";
...
return call_user_func("_id285", $data, $noDataOutput);
}; ?>