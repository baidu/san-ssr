...
componentRenderers._id103 = componentRenderers._id103|| _id103;
var _id103Proto = {
filters: {
...
function _id103(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id103Proto,
...
html += "<span";
if (componentCtx.data.name) {
html += attrFilter("title", escapeHTML(componentCtx.data.name));
}
html += ">";
...
html += "<span";
if (componentCtx.data.name2) {
html += attrFilter("title", escapeHTML(componentCtx.data.name2));
}
html += ">";
html += escapeHTML(componentCtx.data.name2);
html += "</span>";
...
return componentRenderers._id103(data, noDataOutput)
}