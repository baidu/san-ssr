...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"name"}) ? $componentCtx["data"]->{"name"} : null)));
}
$html .= ">";
...
$html .= "<span";
if ((isset($componentCtx["data"]->{"name2"}) ? $componentCtx["data"]->{"name2"} : null)) {
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"name2"}) ? $componentCtx["data"]->{"name2"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"name2"}) ? $componentCtx["data"]->{"name2"} : null));
$html .= "</span>";
