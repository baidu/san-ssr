...
function _id107($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id107Proto = [
"filters" => [
...
$_id108 = (isset($componentCtx["data"]->{"persons"}) ? $componentCtx["data"]->{"persons"} : null);
if (is_array($_id108) || is_object($_id108)) {
foreach ($_id108 as $i => $value) {
...
return call_user_func("_id107", $data, $noDataOutput);
}; ?>