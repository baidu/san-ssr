...
componentRenderers._id115 = componentRenderers._id115|| _id115;
var _id115Proto = {
filters: {
...
function _id115(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id115Proto,
...
var _id116 = componentCtx.data.persons;
if (_id116 instanceof Array) {
for (var i = 0; i < _id116.length; i++) {
componentCtx.data.i=i;
componentCtx.data.p= _id116[i];
html += "<li";
...
return componentRenderers._id115(data, noDataOutput)
}