...
function _id110($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id110Proto = [
"filters" => [
...
$_id111 = (isset($componentCtx["data"]->{"persons"}) ? $componentCtx["data"]->{"persons"} : null);
if (is_array($_id111) || is_object($_id111)) {
foreach ($_id111 as $i => $value) {
...
return call_user_func("_id110", $data, $noDataOutput);
}; ?>