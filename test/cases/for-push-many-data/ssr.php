...
function _id71($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id71Proto = [
"filters" => [
...
$_id72 = (isset($componentCtx["data"]->{"persons"}) ? $componentCtx["data"]->{"persons"} : null);
if (is_array($_id72) || is_object($_id72)) {
foreach ($_id72 as $i => $value) {
...
return call_user_func("_id71", $data, $noDataOutput);
}; ?>