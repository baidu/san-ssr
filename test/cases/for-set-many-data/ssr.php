...
function _id164($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id164Proto = [
"filters" => [
...
$_id165 = (isset($componentCtx["data"]->{"persons"}) ? $componentCtx["data"]->{"persons"} : null);
if (is_array($_id165) || is_object($_id165)) {
foreach ($_id165 as $i => $value) {
...
return call_user_func("_id164", $data, $noDataOutput);
}; ?>