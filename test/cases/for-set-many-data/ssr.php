...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"p"}->{"name"}) ? $componentCtx["data"]->{"p"}->{"name"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"p"}->{"name"}) ? $componentCtx["data"]->{"p"}->{"name"} : null)) . " - " . _::escapeHTML((isset($componentCtx["data"]->{"p"}->{"email"}) ? $componentCtx["data"]->{"p"}->{"email"} : null));
$html .= "</li>";
