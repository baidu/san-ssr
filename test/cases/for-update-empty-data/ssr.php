...
function _id207($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id207Proto = [
"filters" => [
...
$_id208 = (isset($componentCtx["data"]->{"persons"}) ? $componentCtx["data"]->{"persons"} : null);
if (is_array($_id208) || is_object($_id208)) {
foreach ($_id208 as $i => $value) {
...
return call_user_func("_id207", $data, $noDataOutput);
}; ?>