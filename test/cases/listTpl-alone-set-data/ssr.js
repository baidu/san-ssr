...
componentRenderers._id143 = componentRenderers._id143|| _id143;
var _id143Proto = {
filters: {
...
function _id143(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id143Proto,
...
var _id144 = componentCtx.data.persons;
if (_id144 instanceof Array) {
for (var i = 0; i < _id144.length; i++) {
componentCtx.data.i=i;
componentCtx.data.p= _id144[i];
html += "  <h4>";
...
return componentRenderers._id143(data, noDataOutput)
}