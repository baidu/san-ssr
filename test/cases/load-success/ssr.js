...
componentRenderers._id174 = componentRenderers._id174|| _id174;
var _id174Proto = {
filters: {
...
function _id174(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id174Proto,
...
return componentRenderers._id174(data, noDataOutput)
}