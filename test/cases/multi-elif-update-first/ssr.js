...
componentRenderers._id178 = componentRenderers._id178|| _id178;
var _id178Proto = {
filters: {
...
function _id178(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id178Proto,
...
return componentRenderers._id178(data, noDataOutput)
}