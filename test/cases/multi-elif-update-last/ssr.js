...
componentRenderers._id180 = componentRenderers._id180|| _id180;
var _id180Proto = {
filters: {
...
function _id180(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id180Proto,
...
return componentRenderers._id180(data, noDataOutput)
}