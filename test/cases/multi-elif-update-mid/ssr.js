...
componentRenderers._id182 = componentRenderers._id182|| _id182;
var _id182Proto = {
filters: {
...
function _id182(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id182Proto,
...
return componentRenderers._id182(data, noDataOutput)
}