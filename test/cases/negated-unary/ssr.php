...
function _id236($data, $noDataOutput = false, $parentCtx = [], $tagName = null, $sourceSlots = []) {
$_id236Proto = [
"filters" => [
...
$html .= "<u>";
$html .= San::escapeHTML(-(isset($componentCtx["data"]->{"num1"}) ? $componentCtx["data"]->{"num1"} : null)+-(isset($componentCtx["data"]->{"num2"}) ? $componentCtx["data"]->{"num2"} : null));
$html .= "</u></div>";
return $html;
};
return call_user_func("_id236", $data, $noDataOutput);
}; ?>