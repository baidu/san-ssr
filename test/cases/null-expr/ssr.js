...
componentRenderers._id202 = componentRenderers._id202|| _id202;
var _id202Proto = {
filters: {
...
function _id202(data, noDataOutput, parentCtx, tagName, sourceSlots) {
var html = "";
var componentCtx = {
proto: _id202Proto,
...
if (componentCtx.data.nullValue===null) {
html += "<b>b</b>";
...
return componentRenderers._id202(data, noDataOutput)
}