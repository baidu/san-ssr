...
html += "<h3>";
html += escapeHTML(componentCtx.data.a.title);
html += "</h3><h4>";
html += escapeHTML(componentCtx.data.a.from);
html += "</h4>";
if (componentCtx.data.a.hot) {
html += "<b>hot</b>";

}
if (componentCtx.data.a.author) {
html += "<div><u>";
html += escapeHTML(componentCtx.data.a.author.name);
html += "</u><a>";
html += escapeHTML(componentCtx.data.a.author.email);
html += "</a></div>";

}
html += "<p>";
html += escapeHTML(componentCtx.data.a.content);
html += "</p></div>";
return html;
};
...
{"a":{
"author":componentCtx.data.aAuthor,
"from":componentCtx.data.from,
...componentCtx.data.article
}}, true, componentCtx, "x-a", $sourceSlots);
$sourceSlots = null;
html += "</div>";
return html;
};
