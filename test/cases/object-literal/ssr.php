...
$html .= "<h3>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"a"}->{"title"}) ? $componentCtx["data"]->{"a"}->{"title"} : null));
$html .= "</h3><h4>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"a"}->{"from"}) ? $componentCtx["data"]->{"a"}->{"from"} : null));
$html .= "</h4>";
...
$html .= "<div><u>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"a"}->{"author"}->{"name"}) ? $componentCtx["data"]->{"a"}->{"author"}->{"name"} : null));
$html .= "</u><a>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"a"}->{"author"}->{"email"}) ? $componentCtx["data"]->{"a"}->{"author"}->{"email"} : null));
$html .= "</a></div>";

}
$html .= "<p>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"a"}->{"content"}) ? $componentCtx["data"]->{"a"}->{"content"} : null));
$html .= "</p></div>";
return $html;
};
...
(object)["a" => _::objSpread([["author", (isset($componentCtx["data"]->{"aAuthor"}) ? $componentCtx["data"]->{"aAuthor"} : null)],["from", (isset($componentCtx["data"]->{"from"}) ? $componentCtx["data"]->{"from"} : null)],(isset($componentCtx["data"]->{"article"}) ? $componentCtx["data"]->{"article"} : null)], [0,0,1])], true, $componentCtx, "x-a", $sourceSlots);
$sourceSlots = null;
$html .= "</div>";
return $html;
};
