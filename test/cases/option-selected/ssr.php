...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"online"}) ? $componentCtx["data"]->{"online"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"online"}) ? $componentCtx["data"]->{"online"} : null));
$html .= "</b><select";
...
$html .= "<option";
$optionValue = _::escapeHTML((isset($componentCtx["data"]->{"p"}) ? $componentCtx["data"]->{"p"} : null));
...
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"p"}) ? $componentCtx["data"]->{"p"} : null));
$html .= "</option>";
$optionValue = null;
