...
$html .= "<h4>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"subtitle"}) ? $componentCtx["data"]->{"subtitle"} : null));
$html .= "</h4>";

}
$html .= "<p>";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"content"}) ? $componentCtx["data"]->{"content"} : null));
$html .= "</p></div>";
return $html;
};
...
_::extend((isset($componentCtx["data"]->{"article"}) ? $componentCtx["data"]->{"article"} : null), (object)["title" => (isset($componentCtx["data"]->{"title"}) ? $componentCtx["data"]->{"title"} : null)]), true, $componentCtx, "x-a", $sourceSlots);
$sourceSlots = null;
$html .= "<a";
if ((isset($componentCtx["data"]->{"target"}) ? $componentCtx["data"]->{"target"} : null)) {
$html .= _::attrFilter('target', _::escapeHTML((isset($componentCtx["data"]->{"target"}) ? $componentCtx["data"]->{"target"} : null)));
}
