...
$defaultSlotRender = function ($componentCtx) {
  $html = "";
$html .= "<p>";
$html .= _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"n"}) ? $componentCtx["data"]->{"n"} : null)])) . "," . _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"sex"}) ? $componentCtx["data"]->{"sex"} : null)])) . "," . _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"email"}) ? $componentCtx["data"]->{"email"} : null)]));
$html .= "</p>";
