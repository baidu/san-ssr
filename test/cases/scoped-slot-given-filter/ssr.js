...
$sourceSlots.push([function (componentCtx) {
  var html = "";
html += "<h3>";
html += escapeHTML(callFilter(componentCtx, "upper", [componentCtx.data.n]));
html += "</h3><b>";
html += escapeHTML(callFilter(componentCtx, "upper", [componentCtx.data.sex]));
html += "</b><u>";
html += escapeHTML(callFilter(componentCtx, "upper", [componentCtx.data.email]));
html += "</u>";
