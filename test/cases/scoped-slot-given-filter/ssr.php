...
array_push($sourceSlots, [function ($componentCtx) {
  $html = "";
$html .= "<h3>";
$html .= _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"n"}) ? $componentCtx["data"]->{"n"} : null)]));
$html .= "</h3><b>";
$html .= _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"sex"}) ? $componentCtx["data"]->{"sex"} : null)]));
$html .= "</b><u>";
$html .= _::escapeHTML(_::callFilter($componentCtx, "upper", [(isset($componentCtx["data"]->{"email"}) ? $componentCtx["data"]->{"email"} : null)]));
$html .= "</u>";
