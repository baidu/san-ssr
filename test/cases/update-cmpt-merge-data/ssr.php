...
"data" => $data ? $data : ["title" => "title","text" => "text"],
"owner" => $parentCtx,
"slotRenderers" => []
];
if ($data) {
$componentCtx["data"]["title"] = array_key_exists("title", $componentCtx["data"]) ? $componentCtx["data"]["title"] : "title";
$componentCtx["data"]["text"] = array_key_exists("text", $componentCtx["data"]) ? $componentCtx["data"]["text"] : "text";
}
...
"proto" => $_id1Proto,
"sourceSlots" => $sourceSlots,
"data" => $data ? $data : ["jokeName" => "airike","school" => "none"],
"owner" => $parentCtx,
"slotRenderers" => []
];
if ($data) {
$componentCtx["data"]["jokeName"] = array_key_exists("jokeName", $componentCtx["data"]) ? $componentCtx["data"]["jokeName"] : "airike";
$componentCtx["data"]["school"] = array_key_exists("school", $componentCtx["data"]) ? $componentCtx["data"]["school"] : "none";
}
$computedNames = $componentCtx["proto"]["computedNames"];
foreach ($computedNames as $i => $computedName) {
  $data[$computedName] = $componentCtx["proto"]["computed"][$computedName]($componentCtx);
...
$sourceSlots = null;
$html .= "</h5><p><a";
if ((array_key_exists("school", $componentCtx["data"]) ? $componentCtx["data"]["school"] : null)) {
$html .= San::attrFilter('title', San::escapeHTML((array_key_exists("school", $componentCtx["data"]) ? $componentCtx["data"]["school"] : null)));
}
$html .= ">";
$html .= San::escapeHTML((array_key_exists("school", $componentCtx["data"]) ? $componentCtx["data"]["school"] : null));
$html .= "</a><u";
if ((array_key_exists("company", $componentCtx["data"]) ? $componentCtx["data"]["company"] : null)) {
$html .= San::attrFilter('title', San::escapeHTML((array_key_exists("company", $componentCtx["data"]) ? $componentCtx["data"]["company"] : null)));
}
$html .= ">";
