...
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"title"}) ? $componentCtx["data"]->{"title"} : null)));
}
$html .= _::attrFilter('class', _::escapeHTML(_::_xclassFilter((isset($componentCtx["data"]->{"class"}) ? $componentCtx["data"]->{"class"} : null), "label")));
...
"class" => _::escapeHTML(_::_classFilter((isset($componentCtx["data"]->{"labelClass"}) ? $componentCtx["data"]->{"labelClass"} : null))) . " my-label"], true, $componentCtx, "ui-label", $sourceSlots);
$sourceSlots = null;
$html .= "</h5><p><a";
if ((isset($componentCtx["data"]->{"school"}) ? $componentCtx["data"]->{"school"} : null)) {
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"school"}) ? $componentCtx["data"]->{"school"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"school"}) ? $componentCtx["data"]->{"school"} : null));
$html .= "</a><u";
if ((isset($componentCtx["data"]->{"company"}) ? $componentCtx["data"]->{"company"} : null)) {
$html .= _::attrFilter('title', _::escapeHTML((isset($componentCtx["data"]->{"company"}) ? $componentCtx["data"]->{"company"} : null)));
}
$html .= ">";
$html .= _::escapeHTML((isset($componentCtx["data"]->{"company"}) ? $componentCtx["data"]->{"company"} : null));
$html .= "</u></p></div>";
return $html;
};
