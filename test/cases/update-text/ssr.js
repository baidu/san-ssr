...
/* eslint no-unused-vars: "off" */
    ...
    componentRenderers._id320 = componentRenderers._id320 || _id320
    const _id320Proto = {
        filters: {
    ...
    function _id320 (data, noDataOutput, parentCtx, tagName, sourceSlots) {
        let html = ''
        const componentCtx = {
            proto: _id320Proto,
        ...
        const computedNames = componentCtx.proto.computedNames
        ...
        html += '<span'
        if (componentCtx.data.email) {
            html += attrFilter('title', escapeHTML(componentCtx.data.email))
        }
        html += '>'
    ...
    return componentRenderers._id320(data, noDataOutput)
}