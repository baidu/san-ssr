...
describe('TypedComponentInfo', function () {
    ...
    describe('#getFilterNames()', function () {
        it('should return filter names', () => {
            ...
            const info = new TypedComponentInfo('id', null as ANode, new Map(), undefined, true, file.getClass('Foo'))
...
describe('DynamicComponentInfo', function () {
    it('should return filter names', () => {
        ...
        const info = new DynamicComponentInfo('id', null as ANode, new Map(), 'normal', undefined, true, component)
        expect(info.getFilterNames()).toEqual(['a', 'x-b', 'b'])
    })
